...
export default function FeedPage() {
    ...
    for (const place of places) {
        const backSide = (<div className={css.grid}>
            {/* Top of grid */}
        ...
        const frontSide = <ImageSlideShow
        ...
        <section className={css.parameters}>
            <Box>
                ...
                <div>
                    ...
                    {location ? 
                        ` near ${location.address} (lat. ${location.latitude?.toFixed(3)}, lgt. ${location.longitude?.toFixed(3)})`
                        : ' anywhere'} 
